...
for each_folder in all_folders:
    ...
    with detection_graph.as_default():
        with tf.Session(graph=detection_graph, config = config) as sess:
            ...
            df_submit.to_csv('/home/research/DataServer/datasets/external/airbus_ship_detection/submission_csv/submissionSepNoOverRect_th0'+ str(threshold).split('.')[1] +'_full_'+str(iteration_number) +'.csv', index=False)
